...
import Plantilla from './plantilla_carga_tipologias_subtipologias.xlsx';
...
const App = () => {
  ...
  const handleDownloadTemplate = () => {
    ...
    link.href = Plantilla;
    link.download = "plantilla_carga_tipologias_subtipologias.xlsx";
    link.click();
  };
